...
`POST https://us.api.flexprice.io/gw/auth/login`
...
```bash
curl --location --request POST 'https://us.api.flexprice.io/gw/auth/login' \
...
`POST https://us.api.flexprice.io/gw/user/logout`
...
```bash
curl --location --request POST 'https://us.api.flexprice.io/gw/user/logout' \
