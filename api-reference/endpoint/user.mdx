...
`GET https://us.api.flexprice.io/gw/user/me`
...
```bash
curl --location 'https://us.api.flexprice.io/gw/user/me' \
...
`PUT https://us.api.flexprice.io/gw/user/update/{user_id}`
...
```bash
curl --location --request PUT 'https://us.api.flexprice.io/gw/user/update/8f9dbd96-48a9-4aff-9ad5-910976556c65' \
--header 'Authorization: Bearer {your_token}' \
