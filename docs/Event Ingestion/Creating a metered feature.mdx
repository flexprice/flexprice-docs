...
Before you can send events to Flexprice, you need to create a **Metered Feature**. This feature defines what you want to track and how Flexprice should process the incoming events.
...
**Example**: If you set Event Name to `model.usage`, every event you send must have `"event_name": "model.usage"`.
...
![Aggregation Function Selection](/public/images/docs/Product%20catalogue/Features/Creating%20a%20feature/Screenshot_2025-03-08_at_9.25.27_PM.png)
...
**Important**: Note down the **Event Name** and **Aggregation Field** - you'll need these when sending events.
...
- Always test your feature configuration before sending production events
- Use the [Event Debugger](Event%20debugger.md) to validate your setup

## Next Steps

Now that you have a metered feature, you're ready to:

1. [Send Events](Sending%20events.md) - Learn how to send usage data
2. [Validate Events](Validating%20events.md) - Ensure events are being processed correctly
3. [Connect to Billing](Connecting%20to%20billing.md) - Set up pricing and subscriptions
...
- Ensure the customer exists with the correct external_ccustomer_id
...
- Update your application to send events with the new name
