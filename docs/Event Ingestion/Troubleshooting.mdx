...
- [ ] Events are being sent to the correct endpoint
...
**Symptoms**: Events sent successfully (202 response) but don't show up in Events dashboard.
...
3. Compare with what you're sending in events
...
- Send more usage to exceed free tier
...
**Symptoms**: Getting error responses when sending events.
