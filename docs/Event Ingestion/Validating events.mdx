...
After sending events to Flexprice, it's crucial to verify that they're being processed correctly. This guide shows you how to check event ingestion, debug issues, and ensure your billing calculations are accurate.

## Prerequisites

- Events have been sent to Flexprice
...
Click on any event in the list to see the complete payload that was sent:

![Event Details Modal](/public/images/docs/Event%20Ingestion/event_details.png)

This shows you the exact JSON payload that Flexprice received, including:

- All properties sent with the event
...
3. Verify the configuration:
   - **Event Name** matches what you're sending
...
This shows you how Flexprice is calculating the total usage for billing.
...
### Scenario 1: Events Sent but Not Counted
...
**Symptoms**: Events not appearing in Events list
...
1. [Connect to Billing](Connecting%20to%20billing.md) - Set up pricing and subscriptions
2. [Monitor Usage](Monitoring%20usage.md) - Track usage patterns and trends
3. [Optimize Performance](Optimizing%20performance.md) - Improve event ingestion efficiency

## Getting Help

If you're still experiencing issues after following this validation guide:

1. Check the [Event Debugger](Event%20debugger.md) for detailed error messages
