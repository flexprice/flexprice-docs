...
- [COUNT UNIQUE Aggregation](/docs/Product%20catalogue/Features/Aggregation/COUNT%20UNIQUE)
- [LATEST Aggregation](/docs/Product%20catalogue/Features/Aggregation/LATEST)
- [SUM WITH MULTIPLIER Aggregation](/docs/Product%20catalogue/Features/Aggregation/SUM%20WITH%20MULTIPLIER)
- [MAX Aggregation](/docs/Product%20catalogue/Features/Aggregation/MAX)
- [WEIGHTED SUM Aggregation](/docs/Product%20catalogue/Features/Aggregation/WEIGHTED%20SUM)
