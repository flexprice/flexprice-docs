...
**What happens:**
- Credits unused time on current plan
- Charges prorated amount for new plan
- Generates immediate invoice
- Changes take effect immediately

**Best for:**
- Most subscription changes
- When you want immediate access to new features
...
- New plan charged at full price
- Current plan continues until period end
- Changes take effect at next billing period

**Best for:**
- When you want to avoid immediate charges
- When you're near the end of your billing period
- When you want to delay the change
