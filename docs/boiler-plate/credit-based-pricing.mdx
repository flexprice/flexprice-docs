...
<Frame>
  ![Credit-based pricing breakdown](/images/docs/subscription-flow/apollo-credit-based-pricing.png)
</Frame>
...
<Steps>
  ...
  <Step title="Step 1: Create Features (Metered)">
    Navigate to **Flexprice Dashboard** → **Product Catalog** → **Features**
     ...
     <Frame>
  ![Create Features (metered) for credit-based pricing](/images/docs/subscription-flow/credit-based-features.png)
  </Frame>
  ...
  <Step title="Step 2: Create Plan (with Credits or Recurring Grants)">
    Navigate to **Flexprice Dashboard** → **Product Catalog** → **Plans**
     ...
     <Frame>
  ![Add Subscription and credit grants](/images/docs/subscription-flow/add-credit-grant-with-plan.png)
  </Frame>
    ...
    **Do this:** Open the customer → **Add Subscription** → select your plan. **Result:** The customer gets the plan’s credit grants (e.g. monthly) and access to the features you linked to that plan (including any free usage you set).
    ...
    <Frame>
  ![Add Subscription and credit grants](/images/docs/subscription-flow/credit-grants.png)
  </Frame>
  ...
  <Step title="Step 4: Create Customer">
    Navigate to **Flexprice Dashboard** → **Customer Management** → **Customers**
     ...
     <Frame>
  ![Create Customer in Flexprice](/images/docs/subscription-flow/credit-based-customer.png)
  </Frame>
