...
<Frame>
  ![Resend pricing breakdown](/images/docs/subscription-flow/boiler-plate-resend-pricing.png)
</Frame>
...
<Steps>
  <Step title="Step 1: Create metered features">
    ...
    <Frame>
      ![Create a feature](/images/docs/subscription-flow/boiler-plate-create-feature.png)
    </Frame>
  ...
  <Step title="Step 2: Create plan with hybrid charges">
    ...
    <Frame>
      ![Create a plan](/images/docs/subscription-flow/plan-charges.png)
    </Frame>
  ...
  <Step title="Step 3: Set entitlements">
    ...
    <Frame>
      ![Add entitlement to plan](/images/docs/subscription-flow/boiler-plate-add-entitlement.png)
    </Frame>
  ...
  <Step title="Step 5: Create subscription">
    ...
    <Frame>
      ![Add subscription to customer](/images/docs/subscription-flow/boiler-plate-add-subscription.png)
    </Frame>
  ...
  <Step title="Step 6: Usage and billing">
    ...
    - **Verify events:** Use the Event Debugger or usage views to confirm events are received and attributed to the customer.
     <Frame>
      ![usage Events](/images/docs/subscription-flow/usage-event.png)
    </Frame>

    - **Invoices:** Generated at the end of each billing cycle; they include the recurring fee and usage-based line items.
     <Frame>
      ![Subscription Invoice](/images/docs/subscription-flow/subscription-invoice.png)
    </Frame>
