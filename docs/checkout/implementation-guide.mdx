...
<Note>
  **Base URL:** Use `https://us.api.flexprice.io/v1` for US deployments and `https://api.cloud.flexprice.io/v1` for India. All curl examples below use the US endpoint — replace the host if you are on India.
</Note>
