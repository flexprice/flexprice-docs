...
<Frame>![Customer Portal Overview](/images/docs/customers/customer-portal/overview.png)</Frame>
...
<Frame>![Customer Portal Usage — Usage Trend and Usage Breakdown by group](/images/docs/groups/customer-portal.png)</Frame>
