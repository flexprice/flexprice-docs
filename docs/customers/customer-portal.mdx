...
{/* IMAGE PLACEHOLDER: Customer Portal Overview section showing balance, saved cards and subscriptions */}
...
{/* IMAGE PLACEHOLDER: Overview section with wallet balance card, saved payment methods and subscriptions list */}
...
<Frame>![Customer Portal Invoices](/images/docs/customers/customer-portal/invoices.png)</Frame>

{/* IMAGE PLACEHOLDER: Invoice detail drawer showing amount due, line items and the Download and Pay buttons */}
