...
<Frame>![Settings, Customer Portal tab, showing the five portal visibility toggles](/images/docs/customers/customer-portal/customer-portal-settings.png)</Frame>
