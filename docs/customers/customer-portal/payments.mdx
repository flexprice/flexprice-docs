...
{/* IMAGE PLACEHOLDER: Portal Overview showing the wallet balance card with Add credits and Pay now, beside the saved payment methods list */}
...
{/* IMAGE PLACEHOLDER: Invoices section with an overdue invoice row showing the Pay now action */}
...
{/* IMAGE PLACEHOLDER: Add credits dialog showing the credit amount field, preset amounts, provider radio options and the "You'll be charged" line */}
...
{/* IMAGE PLACEHOLDER: Auto top-up card in the Credits section, showing the summary line and the expanded threshold, amount and cooloff fields */}
...
{/* IMAGE PLACEHOLDER: Payment methods card listing two saved cards with the Default badge and the row action menu open */}
