...
To configure **Customer Hierarchy** on a subscription (for example consolidated billing across subsidiaries, or a delegated payer who pays on behalf of another customer), see [Customer Hierarchy](/docs/subscriptions/customer-hierarchy).