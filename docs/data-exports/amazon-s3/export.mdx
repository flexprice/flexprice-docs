...
<Note>
**Full Example File**: Download [invoice-example.csv](/images/docs/data-exports/amazon-s3/csv/invoice-example.csv) to see the complete CSV structure.
</Note>
...
<Note>
**Full Example File**: Download [events-example.csv](/images/docs/data-exports/amazon-s3/csv/events-example.csv) to see the complete CSV structure.
</Note>
...
<Note>
**Full Example File**: Download [credit_topups-report-example.csv](/images/docs/data-exports/amazon-s3/csv/credit_topups-report-example.csv) to see the complete CSV structure.
</Note>
...
<Note>
When using a custom endpoint, ensure your credentials and bucket configuration are compatible with that provider's S3 API implementation.
</Note>
...

{
  ...
  "entity_type": "invoice",  // Options: "invoice", "events", "credit_topups"
  "interval": "daily",
  "enabled": true,
  "job_config": {
...
- **Three Data Types**: Export invoices, events, and credit top-ups data
