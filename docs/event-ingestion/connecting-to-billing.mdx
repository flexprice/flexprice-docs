...
<Frame>
  ![Plan Configuration](/images/docs/event-ingestion/create_feature.png)
</Frame>
...
<Frame>
  ![Create Subscription](/images/docs/event-ingestion/setting_event_name.png)
</Frame>
...
<Frame>
  ![Upcoming Invoices](/images/docs/event-ingestion/upcoming_invoices.png)
</Frame>
