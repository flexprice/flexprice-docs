...
<Frame>
  ![cURL Event Ingestion Example](/images/docs/event-ingestion/event_ingestion_curlpreview_feature_create.png)
</Frame>
...
<Frame>
  ![Postman Event Ingestion Example](/images/docs/event-ingestion/event_ingestion_postman.png)
</Frame>
