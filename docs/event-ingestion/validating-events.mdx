...
<Frame>
  ![Events Dashboard](/images/docs/event-ingestion/query_tab.png)
</Frame>
...
<Frame>
  ![Event Details Modal](/images/docs/event-ingestion/event_details.png)
</Frame>
...
<Frame>
  ![Query Tab Event Preview](/images/docs/event-ingestion/query_tab_event_preview.png)
</Frame>
