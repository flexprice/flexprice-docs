...
<CardGroup cols={2}>
  ...
  <Card icon="/images/developers/icons/chart-bar.svg" href="/docs/exportable-ui/usage-widgets/usage-widgets" title="Usage Widgets">
