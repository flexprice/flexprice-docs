...
<CardGroup cols={4}>
  <Card icon="/images/developers/icons/palette.svg" title="Themeable">
    One CSS variable away from your brand.
  </Card>
  <Card icon="/images/developers/icons/moon.svg" title="Dark mode built in">
    Every component ships a light and dark treatment.
  </Card>
  <Card icon="/images/developers/icons/code.svg" title="Full TypeScript">
    Typed props and adapters, no `any`.
  </Card>
  <Card icon="/images/developers/icons/server.svg" title="SSR-ready">
...
<Card icon="/images/developers/icons/file-text.svg" title="Feed this to an LLM" href="https://docs.flexprice.io/llms-full.txt">
...
### UI kit peer dependencies

`react` and `react-dom` (v18).

### Importing the UI kit stylesheet
...
You can also override appearance with CSS variables, Tailwind, CSS Modules, or other styling approaches — see [Theming](#theming-the-ui-kit).

## Ways to provide data to the components
...
### Option 1: Fetch with the Flexprice SDK (recommended)
...
### Option 2: Fetch from the Flexprice REST API
...
### Option 3: Fetch through your own backend
...
### Option 4: Fetch from your own APIs
...
## Event callbacks on the components
...
## Server-side rendering the UI kit
...
## A typical UI kit integration flow
...
<Steps>
  ...
  <Step title="Choose a data source">
    Pick Flexprice SDK, REST APIs, your backend, your own APIs, or static JSON — see [Ways to provide data](#ways-to-provide-data-to-the-components).
  </Step>
...
## Components planned for the UI kit
