...
<Frame>
  ![Environments](/images/docs/getting-started/environment-selector.png)
</Frame>
...
<Frame>
  ![API Keys Page](/images/docs/getting-started/api-keys-page.png)
</Frame>

2. Click **Add** to create a new API key
<Frame>
  ![Create API Key](/images/docs/getting-started/create-api-key.png)
</Frame>
...
4. Click **Create**
<Frame>
  ![Created API Key](/images/docs/getting-started/created-api-key.png)
</Frame>
