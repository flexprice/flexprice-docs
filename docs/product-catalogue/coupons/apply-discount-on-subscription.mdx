...
1. [Created a coupon](/docs/product-catalogue/coupons/create) that is active and within its validity period
...
1. In the main navigation menu, select **Billing**.
2. Select **Customers**.
3. Find and select the customer you want to apply the discount to.
