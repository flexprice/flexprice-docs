...
# Get a coupon
curl https://us.api.flexprice.io/v1/coupons/<coupon_id> \
  -H "x-api-key: <API_KEY>"
...
curl -X PUT https://us.api.flexprice.io/v1/coupons/<coupon_id> \
  -H "x-api-key: <API_KEY>" \
  -H "Content-Type: application/json" \
  -d '{ "name": "Summer Sale 2025" }'

# Delete a coupon
curl -X DELETE https://us.api.flexprice.io/v1/coupons/<coupon_id> \
  -H "x-api-key: <API_KEY>"
```
