...
1. **[Create a Coupon](/docs/product-catalogue/coupons/create)**: Set up your first discount offer
2. **[Apply to Subscriptions](/docs/product-catalogue/coupons/apply-discount-on-subscription)**: Learn how to apply coupons to customer subscriptions
