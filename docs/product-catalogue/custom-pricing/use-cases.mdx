---
title: "Use cases"  
Use a **custom price unit** (custom currency) when adding charges to a plan. You can add **recurring** and **usage-based** charges in that unit. Flexprice shows values in the custom unit (e.g. fpc) and bills in your base currency (e.g. USD).
