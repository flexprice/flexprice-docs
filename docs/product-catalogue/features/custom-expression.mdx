...
<Steps>
  ...
  <Step title="Add the custom expression">
    ...
    <Frame>
      ![Aggregation section with the Custom expression toggle highlighted](/public/images/docs/Product%20catalogue/Features/Custom%20expressions/Screenshot%202026-07-09%20at%201.43.57%20PM_edited.png)
    </Frame>

    Enter a CEL formula in the **Custom Expression** field. Variables are the top-level property names on your events.

    <Frame>
      ![Custom Expression field with ceil(duration_ms / 1000) and inline help text listing available functions](/public/images/docs/Product%20catalogue/Features/Custom%20expressions/Screenshot%202026-07-09%20at%201.44.21%20PM.png)
    </Frame>
  </Step>
