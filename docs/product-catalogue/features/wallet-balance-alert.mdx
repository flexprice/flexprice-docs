...
**Example**: Balance falls below $0, meaning service may be interrupted within hours.

### 2. Warning - Medium Priority
**When to Use**: When attention is needed soon, but there's still time to take action.

**Example**: Balance falls below $10, indicating low balance that needs replenishment soon.

### 3. Info - Lowest Priority
**When to Use**: For informational tracking and usage milestones.

**Example**: Balance falls below $20, serving as an early tracking indicator.
...
2. **Condition**: The direction that triggers an alert
   - **"below"**: Alert when balance drops below the threshold
   - **"above"**: Alert when balance rises above the threshold
...
**How it works**: Customer has a prepaid wallet starting with $100. As ongoing-balance depletes:
- At $20 → Info alert (informational milestone, balance getting low)
- At $10 → Warning alert (low balance, needs top-up soon)
- At $0 → Critical alert (urgent, service will be interrupted)
...
- At $100 → Info alert (spending milestone reached)
- At $500 → Warning alert (halfway to spending limit)
- At $1,000 → Critical alert (spending limit reached, action required)
...
**Alert Condition**
- **Below**: Alert when balance drops below the threshold (for monitoring balance depletion)
- **Above**: Alert when balance rises above the threshold (for monitoring spending/usage)

<Warning>
All thresholds must use the same condition. You cannot mix "above" and "below" within the same feature.
</Warning>
...
1. Balance drops to $20 → **OK → Info**
2. Balance drops to $10 → **Info → Warning**
3. Balance drops to $0 → **Warning → In Alarm**
...
1. Large transaction: Balance drops to $5 → **OK → Warning** (skips info)
2. Another transaction: Balance drops to -$2 → **Warning → In Alarm**

**Scenario 3: Usage increase (above condition)**

Starting balance/usage: $0 (below all thresholds)

1. Usage reaches $100 → **OK → Info**
2. Usage reaches $500 → **Info → Warning**
3. Usage reaches $1000 → **Warning → In Alarm**
