...
<Frame>
  ![Alert Settings Dropdown](/images/docs/product-catalogue/features/wallet-balance-alerts/alert-settings-dropdown.png)
</Frame>
...
<Frame>
  ![Configure Feature Alert Settings](/images/docs/product-catalogue/features/wallet-balance-alerts/update-feat-add-alerts.png)
</Frame>
