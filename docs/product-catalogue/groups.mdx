...
<Steps>
  <Step title="Navigate to Groups">
    ...
    <Frame>
      ![Groups list](/images/docs/groups/list.png)
    </Frame>
  </Step>
  ...
  <Step title="Create a group">
    ...
    - Click **Create Group**
    <Frame>
      ![Create Group](/images/docs/groups/create.png)
    </Frame>
  </Step>
  ...
  <Step title="Assign group when adding a charge">
    ...
    <Frame>
      ![Assign group to charges](/images/docs/groups/assign-group-to-charges.png)
    </Frame>
  </Step>
  ...
  <Step title="Change group on an existing price">
    ...
    - Save
    <Frame>
      ![Update group in price](/images/docs/groups/update-group-in-price.png)
    </Frame>
  </Step>
</Steps>
...
<Frame>
  ![Usage breakdown by group](/images/docs/groups/analytics-usage-breakdown.png)
</Frame>
