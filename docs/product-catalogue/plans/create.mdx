...
* Click **“Add”** at the top-right of the screen.
  ...
  <Frame>
    ![Add Plan Button](/images/docs/product-catalogue/plans/creating-a-plan/add-plan-button.png)
  </Frame>
...
* **Plan Description** *(Optional)*: Provides internal context about the plan.
  ...
  <Frame>
    ![Plan Details](/images/docs/product-catalogue/plans/creating-a-plan/plan-details.png)
  </Frame>
...
<Frame>
  ![Plan Charges](/images/docs/product-catalogue/plans/creating-a-plan/plan-charges.png)
</Frame>
...
* **Setting-up a recurring charge:**
  ...
  <Frame>
    ![Recurring Charge](/images/docs/product-catalogue/plans/creating-a-plan/recurring-charge.png)
  </Frame>
...
* **Setting-up a usage-based charge:**
  ...
  <Frame>
    ![Usage Based Charge](/images/docs/product-catalogue/plans/creating-a-plan/usage-based-charge.png)
  </Frame>
