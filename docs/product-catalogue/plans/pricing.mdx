...
3. Click **"Add Pricing Plan"** at the top-right of the screen.
   <Frame>![Add Pricing Plan](/images/docs/product-catalogue/plans/pricing/add-pricing-plan.png)</Frame>
...
<Frame>![Plan Details Form](/images/docs/product-catalogue/plans/pricing/plan-details-form.png)</Frame>
<Frame>![Plan Configuration](/images/docs/product-catalogue/plans/pricing/plan-configuration.png)</Frame>
...
- Click **Next** to continue.
  <Frame>![Billing Preferences](/images/docs/product-catalogue/plans/pricing/billing-preferences.png)</Frame>
...
<Frame>![Multiple Charges](/images/docs/product-catalogue/plans/pricing/multiple-charges.png)</Frame>
...
<Frame>![Recurring Charge](/images/docs/product-catalogue/plans/pricing/recurring-charge.png)</Frame>
...
- Select the pricing model.
  ...
  - **Flat fee**
    ...
    **Example:** $0.01 per API call.
    ...
    <Frame>![Flat Fee Pricing](/images/docs/product-catalogue/plans/pricing/flat-fee-pricing.png)</Frame>

  - **Package pricing**
    Select the package charge model if you want to apply a **fixed price to a range of units**.
    **Example:** $5 per 100 API calls.

    <Frame>![Package Pricing](/images/docs/product-catalogue/plans/pricing/package-pricing.png)</Frame>
  ...
  - **Volume tiered based pricing**
    ...
    **Example:**- 0 – 10,000 calls → $0.001 per call
    - 10,001 – ∞ calls → $0.0008 per call
      ...
      <Frame>
        ![Volume Tiered Pricing](/images/docs/product-catalogue/plans/pricing/volume-tiered-pricing.png)
      </Frame>
...
<Frame>![Hybrid Charges](/images/docs/product-catalogue/plans/pricing/hybrid-charges.png)</Frame>
...
_For technical implementation details and advanced use cases, refer to the [API Reference](/api-reference//plans/create-plan)._
