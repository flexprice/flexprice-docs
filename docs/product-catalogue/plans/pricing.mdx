...
_For technical implementation details and advanced use cases, refer to the [API Reference](/api-reference/plans/query-plan) and [API Reference](/api-reference/prices/query-price)._
