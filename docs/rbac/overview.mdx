...
For services that need unrestricted access to every Flexprice resource.
...
For teammates who manage billing configuration day to day.
...
For teammates who review billing data without changing it, and for integrations that need read-only API keys.
