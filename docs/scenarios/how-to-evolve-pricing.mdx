...
<Frame>
  ![Build a scenario from existing plan prices](/images/docs/scenarios/scenarios-packaging.png)
</Frame>
...
<Frame>
  ![Update rates in a scenario hypothesis](/images/docs/scenarios/scenarios-rate-update.png)
</Frame>
...
<Frame>
  ![Credits-first model in a scenario](/images/docs/scenarios/scenarios-credits-model.png)
</Frame>
