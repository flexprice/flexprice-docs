...
<Note>
  This page covers consolidated billing and delegated invoicing. Flexprice now has a dedicated **Billing Workflows** section with full coverage of all four workflows, including grouped invoicing.

  - [Overview: Which workflow do I need?](/docs/subscriptions/billing-workflows/overview)
  - [Standalone](/docs/subscriptions/billing-workflows/standalone)
