...
<Frame>
  ...
  modal](/images/docs/customer-hierarchy/add-customers-to-inherit.png)
</Frame>
...
<Frame>
  ...
  customer](/images/docs/customer-hierarchy/inherited-subscriptions-table.png)
</Frame>
...
<Tabs>
  <Tab title="Dashboard">
    ...
    <Frame>
      ![Subscription create form showing Customer Hierarchy section with child customer IDs](/images/docs/customer-hierarchy/inherited-cust-subscription-creation.png)
    </Frame>
