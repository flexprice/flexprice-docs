...
<Steps>
  ...
  <Step title="Open the line item's menu">
    ...
    <Frame>
      ![Open Alert Settings](/images/docs/subscriptions/spend/three-dot-line-items-settings.png)
    </Frame>
  </Step>
  ...
  <Step title="Enable alerts">
    ...
    <Frame>
      ![Enable Alerts](/images/docs/subscriptions/spend/enable-line-item-alert-settings.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure thresholds">
    ...
    <Frame>
      ![Configure thresholds](/images/docs/subscriptions/spend/configure-line-item-alert-settings.png)
    </Frame>
  </Step>
</Steps>
