...
<Steps>
  ...
  <Step title="Open Alert Settings">
    ...
    <Frame>
      ![Open Alert Settings](/images/docs/subscriptions/spend/three-dot-subscription-alert-settings.png)
    </Frame>
  </Step>
  ...
  <Step title="Enable alerts">
    ...
    <Frame>
      ![Enable Alerts](/images/docs/subscriptions/spend/enable-subscription-alert-settings.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure thresholds">
    ...
    <Frame>
      ![Configure thresholds](/images/docs/subscriptions/spend/configure-subscription-alert-settings.png)
    </Frame>
  </Step>
</Steps>
