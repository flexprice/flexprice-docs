...
<Steps>
  ...
  <Step title="Pricing in the plan">
    ...
    <Frame>
      ![Pricing configured in the plan](/images/docs/subscriptions/reservation-discount/line-item-price.png)
    </Frame>
  </Step>
  <Step title="Configure commitment from the line item">
    ...
    <Frame>
      ![Select 'Configure Commitment' from the line item menu](/images/docs/subscriptions/reservation-discount/configure-commitment.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure the commitment details">
    ...
    <Frame>
      ![Configure commitment type, quantity, overage factor, and true-up](/images/docs/subscriptions/reservation-discount/quantity-commitment.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Configure the windowed commitment details">
    ...
    <Frame>
      ![Configure commitment for windowed setup](/images/docs/subscriptions/reservation-discount/configure-commitment-window.png)
    </Frame>
  </Step>
...
<Note>
  Reservation discount applies per-charge commitment and overage. For a single minimum spend across the **entire subscription**, see [Commitment](/docs/subscriptions/commitment/overview).
</Note>
