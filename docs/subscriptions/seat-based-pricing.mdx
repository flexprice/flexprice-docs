...
<Frame>
  ![Creating a subscription with seat count](/images/docs/subscriptions/seat-based/create-subscription-seats.png)
</Frame>
...
<Frame>
  ![Review changes preview](/images/docs/subscriptions/seat-based/modify-seats-review.png)
</Frame>
...
<Frame>
  ![Adjusting seat count in the UI](/images/docs/subscriptions/seat-based/modify-seats-ui.png)
</Frame>
...
<Frame>
  ![Seat change history on subscription](/images/docs/subscriptions/seat-based/seat-history.png)
</Frame>
...
<Frame>
  ![Invoice line items for a seat change](/images/docs/subscriptions/seat-based/invoice-seat-change.png)
</Frame>
