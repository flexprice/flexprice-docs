...
<Steps>
  ...
  <Step title="Go to Auto Top-up">
    ...
    <Frame>
      ![Access Wallet Settings](/images/docs/wallet/auto-top-up/three-dot-goto.png)
    </Frame>
  </Step>
  ...
  <Step title="Enable Auto Top-Up">
    ...
    <Frame>
      ![Enable Auto Top-Up](/images/docs/wallet/auto-top-up/enable.png)
    </Frame>
  </Step>
  ...
  <Step title="Configure Auto Top-Up Settings">
    ...
    <Frame>
      ![Configure Auto Top-Up](/images/docs/wallet/auto-top-up/configure.png)
    </Frame>
    <Frame>
