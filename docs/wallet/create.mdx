...
* If no wallet exists for the customer, you will see a message: *“No wallet linked to the customer yet.”*
  ...
  <Frame>
    ![No Wallet Linked](/images/docs/wallet/creating-a-wallet/no-wallet-linked.png)
  </Frame>
...
* Fill out the following details:
  ...
  <Frame>
    ![Wallet Form](/images/docs/wallet/creating-a-wallet/wallet-form.png)
  </Frame>
...
* The wallet will now appear in the Wallet tab for the customer, showing the balance and available credits.
  ...
  <Frame>
    ![Wallet Created](/images/docs/wallet/creating-a-wallet/wallet-created.png)
  </Frame>