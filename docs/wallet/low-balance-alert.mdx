...
Select **Absolute** or **Percentage** above the Critical, Warning, and Info cards. Switching between the two keeps both sets of values, so you can enter Percentage thresholds, switch back to check your Absolute thresholds, and switch again without losing either set. Only the active type is saved when you click **Save Changes**.

<Frame>
  ![Percentage threshold type selected, showing the ongoing-balance warning](/images/docs/wallet/low-balance-alert/percentage-threshold-type.png)
</Frame>
...
<Steps>
  ...
  <Step title="Configure Thresholds">
    - Choose **Absolute** or **Percentage** as the threshold type.
