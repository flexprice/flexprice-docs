...
**Payment Link**
Generate secure payment links for online transactions. Supports multiple payment gateways including Stripe. Invoice status updates automatically upon successful payment. For detailed payment link behavior, check out [Stripe Payment Link and Checkout Flow](/integrations/stripe/payment-links).
