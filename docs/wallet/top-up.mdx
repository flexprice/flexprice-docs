...
<Steps>
  ...
  <Step title="Configure Credit Amount">
    ...
    <Frame>
      ![Screenshot 2025-03-12 at 6.20.01 PM.png](/public/images/docs/Wallet/Top-up%20wallet/add-credits.png)
    </Frame>
  </Step>
...
- **Purchased Credits (With Invoice)** — Invoice-based workflow with payment tracking

---

> **Disclaimer**
>
> The following section documents **only the Purchased Credits with Invoice** flow.
...
For complete transaction lifecycle details, see [Purchased Credits (Invoiced)](http://localhost:3001/docs/wallet/transactions#purchased-credits-invoiced) in the Wallet Transactions documentation.
...
**Payment Link**
Generate secure payment links for online transactions. Supports multiple payment gateways including Stripe. Invoice status updates automatically upon successful payment.
