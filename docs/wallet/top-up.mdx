...
<Steps>
  ...
  <Step title="Payment Recorded">
    Payment is recorded through your chosen method (payment link, offline payment, etc.). The invoice payment status updates accordingly
     <Frame>
