...
**Endpoint:** `POST /v1/marketplace/agreements`
...
| The `license_arn` is not already registered to a different subscription | `agreement identifier already registered` |
| The subscription is not already registered to a different `license_arn` | `subscription already mapped to a different agreement identifier` |
