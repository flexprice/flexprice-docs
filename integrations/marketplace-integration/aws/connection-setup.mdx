...
| `sync_config.aws_marketplace.region` | The AWS region your product's Marketplace Metering Service is enabled in | ✅ |
...
Both credentials are stored encrypted. `sync_config.aws_marketplace.region` selects the AWS Marketplace Metering Service endpoint your usage is reported to.
