...
**Important**: The QuickBooks integration is **one-way only** (Flexprice → QuickBooks). Invoices created in Flexprice are automatically synced to QuickBooks when enabled.
...
4. Fill in app details:
   - **App Name**: "My App" (or your preferred name) following the naming quickbooks' naming conventions. Go to [View naming guidelines](https://developer.intuit.com/app/developer/qbo/docs/go-live/list-on-the-app-store/naming-and-logo-guidelines)
