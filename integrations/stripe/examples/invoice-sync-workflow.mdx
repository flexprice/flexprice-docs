...
**🔗 API Reference:** [Create Customer API](/api-reference/customers/create-a-customer)
...
**🔗 API Reference:** [Create Payment API](/api-reference/payments/create-a-new-payment)
...
**🔗 API Reference:** [Create Subscription API](/api-reference/subscriptions/create-a-subscription)
...
<Steps>
  <Step title="Automatic Payment Attempt">
    ...
    **If failed:**
    ...
    - Flexprice marks payment as failed
    - Stripe retries based on retry settings
  </Step>
  ...
  <Step title="Webhook Processing">
    ...
    **Supported Events:**
    - `invoice.payment_succeeded` - Updates invoice to paid
    - `invoice.payment_failed` - Marks payment as failed
    - `checkout.session.completed` - Confirms payment link completion
...
**🔗 API Reference:** [Get Invoice API](/api-reference/invoices/get-an-invoice-by-id)
