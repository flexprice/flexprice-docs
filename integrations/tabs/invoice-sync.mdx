...
1. The Tabs connection is **active**
2. **Invoice Sync** is **enabled** on the connection
...
Because invoices arrive in Tabs as drafts, you can adjust them in Tabs before finalizing and collecting payment there.
...
- [Connection Setup](/integrations/tabs/connection-setup) - Set up your Tabs connection and API key
