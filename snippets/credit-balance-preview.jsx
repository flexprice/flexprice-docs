    ...
    <div>
      ...
      >
        ...
        <div style={{ border: `1px solid ${t.line}`, borderRadius: 12, overflow: 'hidden', background: t.surface, width: 340 }}>
          <div style={{ padding: 20, borderBottom: `1px solid ${t.line}`, display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 14, color: t.content }}>Main Wallet</div>
              <span
                style={{
                  fontSize: 10,
          ...
          <div style={{ padding: 20 }}>
            ...
            <div style={{ fontSize: 12, color: t.contentMuted, marginTop: 4 }}>${(balance / 100).toFixed(2)} value</div>
          </div>
        </div>
      </div>
      <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 12, maxWidth: 340 }}>
        <label style={{ fontSize: 12, color: t.contentMuted }}>
          ...
          <input type="range" min="0" max="10000" step="100" value={balance} onChange={(e) => setBalance(Number(e.target.value))} style={{ width: '100%', marginTop: 4 }} />
        </label>
